...
let store = {
    ...
    dispatch(action) {
        if(action.type === ADD_POST) {
            let countPosts = this._state.profilePage.posts.length;
            let newPost = {
                id: countPosts + 1, message:  this._state.profilePage.newPostText, likesCount: 0
            };
            ...
            let countMessages = this._state.dialogsPage.messages.length;
            let newMessage = {
